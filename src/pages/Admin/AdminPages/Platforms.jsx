...
import { useCreatePlatformsMutation, useDeletePlatformsMutation, useGetPlatformsQuery, useUpdatePlatformsMutation } from "../../../store/services/epicApi"
...
function Platforms() {
    ...
    const [newFeature, { isLoading: platformsLoader }] = useCreatePlatformsMutation()
    const [deletePlatforms] = useDeletePlatformsMutation()
    ...
    const handleSave = async () => {
        if (update) {
            ...
            toast.success("Platforms Created")
            close()
        }
    }
    const close = () => {
        ...
        <div className=''>
            <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
                <div className="flex items-center justify-between pb-4">
                    <h2 className="mb-4 text-2xl font-semibold leading-tight">Platforms</h2>
                    <button onClick={() => setOpen(true)} className="bg-black cursor-pointer text-white px-2 py-3 rounded font-semibold">Create Platforms</button>
                </div>
