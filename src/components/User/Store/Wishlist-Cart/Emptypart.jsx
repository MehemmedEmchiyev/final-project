        ...
        <div>
            <div className="flex items-center justify-center py-10 border-b border-[#343437]">
                <div className="w-full flex flex-col items-center justify-center">
                    ...
                    <p className="text-[32px] text-center pt-5 md:text-[40px] line-clamp-2 text-white font-extrabold">You haven't added anything to <br /> your {location} yet.</p>
