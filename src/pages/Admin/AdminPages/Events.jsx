...
import { useCreateEventsMutation, useDeleteEventsMutation, useGetEventsQuery, useUpdateEventsMutation } from "../../../store/services/epicApi"
...
function Events() {
    ...
    const [newFeature, { isLoading: eventsLoader }] = useCreateEventsMutation()
        ...
        <div className=''>
            <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
                <div className="flex items-center justify-between pb-4">
                    ...
                    <button onClick={() => setOpen(true)} className="bg-black cursor-pointer text-white px-2 py-3 rounded font-semibold">Create Events</button>
                </div>
